...
export default function PurchaseConfirmationComponent() {
  ...
  const onSaveOrder = async () => {
    ...
    try {
      const result = await axios.post('/Order', Object.assign(
        {
          products: cartState, 
          DeliveryAddressId : shippingAddress.id,
          user_email : user.email,
  ...
  return (
    <div className="row justify-content-center align-items-center g-4">
      ...
      <div className="col-md-6 ">
        <SelectShippingAddressComponent setShippingAddress={setShippingAddress} shippingAddress={shippingAddress} />
      </div>
      ...
      <div className="col-md-6">
        <button type="button" onClick={onSaveOrder} class="btn btn-success w-100 py-4 fs-4 fw-bold" >COMPRAR</button>
      </div>
    </div>
  );
}
