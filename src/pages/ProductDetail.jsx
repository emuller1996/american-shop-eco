                    ...
                    <div class="row">
                                ...
                                <div id="multi-item-example" class="col-10 carousel slide carousel-multi-item" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner product-links-wap" role="listbox">
                                        ...
                                        <div class="carousel-item active">
                                            <div class="row">
                                                <div class="col-12">
                                                    <img class="card-img img-fluid" src={productDetail && productDetail.image} alt="ProductImage1" />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-7 mt-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <button type="button" onClick={()=> { history.goBack()}} class="btn btn-danger btn-lg float-end" ><i class="fas fa-chevron-left"></i></button>
                                    <h1 class="h2"> {productDetail ? productDetail.name : <span className="placeholder col-8 rounded"></span>} </h1>
                                    <p class="h3 py-2  placeholder-glow">{productDetail ? `$ ${productDetail.price}.00` : <span class="placeholder col-3 rounded"></span>}</p>
                                    <p class="py-2">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <h4 class="text-muted placeholder-glow">{productDetail ? `${productDetail.brand}` : <span class="placeholder col-6"></span>}</h4>
                                        </li>
                                    </ul>

                                    <h6>Description:</h6>
                                    <p className='placeholder-glow '>{productDetail ? `${productDetail.description}` :
                                        <>
